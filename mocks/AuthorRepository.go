...
func (_m *AuthorRepository) Find(ctx context.Context, query *valueobject.Query) []*entity.Author {
...
func (_m *AuthorRepository) First(ctx context.Context, query *valueobject.Query) *entity.Author {
	ret := _m.Called(ctx, query)
